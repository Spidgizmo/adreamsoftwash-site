...
insert into auth.users (id, instance_id, aud, role, email, encrypted_password, email_confirmed_at, created_at, updated_at, raw_app_meta_data, raw_user_meta_data, confirmation_token, email_change, email_change_token_new, recovery_token)
values
...
-- BEGIN GENERATED CATALOG: do not edit; run npm run catalog:generate
insert into public.service_plans(id,display_name,current_version,status,public_visible,referral_eligible) values
('monthly','Monthly','2026-08-02-approved-pricing','active',true,true),
('quarterly','Quarterly','2026-08-02-approved-pricing','active',true,false),
('twice-yearly','Twice a Year','2026-08-02-approved-pricing','active',true,false),
('one-time','One-Time Cleaning','2026-08-02-approved-pricing','active',true,false),
('every-two-weeks','Every 2 Weeks','2026-08-02-approved-pricing','future',false,false);
...
('monthly','2026-08-02-approved-pricing','recurring',1,2000,500,1,'2026-08-02'),
('quarterly','2026-08-02-approved-pricing','recurring',3,3500,500,1,'2026-08-02'),
('twice-yearly','2026-08-02-approved-pricing','recurring',6,5000,1000,2,'2026-08-02'),
('one-time','2026-08-02-approved-pricing','one-time',null,6000,1000,2,'2026-08-02'),
('every-two-weeks','2026-08-02-approved-pricing','recurring',null,null,null,null,'2026-08-02');
...
('20000000-0000-4000-8000-000000000005',null,'Taylor Referral — FICTIONAL','taylor@example.test','555-010-1005','active');
...
('30000000-0000-4000-8000-000000000005','20000000-0000-4000-8000-000000000005','10000000-0000-4000-8000-000000000001','50 Referral Avenue','Test Township','OH','00000','test-hash-5','Beside garage','No access restrictions',null);
...
('30000000-0000-4000-8000-000000000005','REFERRAL-1','Fictional referral cart',false);
...
('20000000-0000-4000-8000-000000000005',(select id from service_plan_versions where plan_id='monthly'),'2026-07-18');
...
('a0000000-0000-4000-8000-000000000005','20000000-0000-4000-8000-000000000005',(select id from subscriptions where customer_id='20000000-0000-4000-8000-000000000005'),(select id from service_plan_versions where plan_id='monthly'),'2026-07-18','2026-08-17','test_paid','test-cycle-referral-monthly-2026-07');
...
('b0000000-0000-4000-8000-000000000005','20000000-0000-4000-8000-000000000005','a0000000-0000-4000-8000-000000000005','due','test-entitlement-referral-monthly-2026-07','2026-07-18');
...
('80000000-0000-4000-8000-000000000005','20000000-0000-4000-8000-000000000005',null,null,'2026-07-18 09:00Z','after_photo_complete',true,true,'b0000000-0000-4000-8000-000000000005');
...
('80000000-0000-4000-8000-000000000005','before','test-only/visit-5-before-placeholder.jpg','00000000-0000-4000-8000-000000000010'),
('80000000-0000-4000-8000-000000000005','after','test-only/visit-5-after-placeholder.jpg','00000000-0000-4000-8000-000000000010');
update public.service_visits set status='completed',completed_at='2026-07-18 10:00Z' where id='80000000-0000-4000-8000-000000000005';
...
('91000000-0000-4000-8000-000000000001','90000000-0000-4000-8000-000000000001','20000000-0000-4000-8000-000000000001','20000000-0000-4000-8000-000000000002','test-hash-2','pending_first_service',null,null,now()),
...
('91000000-0000-4000-8000-000000000003','90000000-0000-4000-8000-000000000001','20000000-0000-4000-8000-000000000001','20000000-0000-4000-8000-000000000005','test-hash-5','qualified','2026-07-25 10:00Z',null,'2026-07-18 08:00Z');
insert into public.referral_credits(customer_id,referral_relationship_id,amount_cents,remaining_cents,status,earned_at,expires_at) values ('20000000-0000-4000-8000-000000000001','91000000-0000-4000-8000-000000000003',1000,1000,'issued','2026-07-25 10:00Z','2027-07-25 10:00Z');
...
('20000000-0000-4000-8000-000000000005','FICTIONAL ELIGIBLE MONTHLY REFERRED CUSTOMER scenario.','00000000-0000-4000-8000-000000000010');
