...
test("ONE45 is the locked private card campaign code", () => {
  ...
  assert.equal(campaign.publiclyAdvertisedOnGeneralWebsite, false);
  assert.equal(campaign.redemptionMethod, "customer-enters-promo-code-at-checkout");
...
test("launch discounts remain mutually exclusive", () => {
