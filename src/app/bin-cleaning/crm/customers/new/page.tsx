  ...
  return (
    <AppShell area="Internal CRM">
      <div className="max-w-4xl">
        ...
        {searchParams.error && <p className="mt-4 rounded-xl bg-red-50 p-4 font-bold text-red-900">The server could not save the customer after the form passed local validation. Try again and we will trace the save failure if it repeats.</p>}
        <ManualCustomerForm />
      </div>
    </AppShell>
  );
