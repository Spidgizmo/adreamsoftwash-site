...
export function SiteHeader() {
  ...
  return (
    <>
      {isBinCleaning && (
        <style>{`
          main ul > li.bg-brand-50:nth-child(odd) > span { background-color: var(--ads-blue) !important; }
          main ul > li.bg-brand-50:nth-child(even) > span { background-color: var(--ads-red) !important; }
        `}</style>
      )}
